...
public function getData(Request $request)
    {
        ...
        try {
            ...
            $response = Http::withToken($token)
                ->get($baseUrl . '/api/kategori/datatables', $request->all());
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $response = Http::withToken($token)
                ->post($baseUrl . '/api/kategori', $request->all());
        } catch (\Throwable $e) {
    ...
    public function show($id)
    {
        ...
        $html = view('backend.master.kategori.show', ['data' => $data])->render();
    ...
    public function edit($id)
    {
        ...
        try {
            $response = Http::withToken($token)->get($baseUrl . '/api/kategori/' . $id);
        } catch (\Exception $e) {
        ...
        $html = view('backend.master.kategori.edit', ['data' => $data])->render();
        return response()->json(['html' => $html], 200);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $response = Http::withToken($token)
                ->put($baseUrl . '/api/kategori/' . $id, $request->all());
        } catch (\Throwable $e) {
            return response()->json(['status' => false, 'message' => 'Tidak dapat menghubungi server backend.'], 500);
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            $response = Http::withToken($token)->delete($baseUrl . '/api/kategori/' . $id);
        } catch (\Exception $e) {
            return response()->json(['status' => false, 'message' => 'Tidak dapat menghubungi server backend.'], 500);
        }
