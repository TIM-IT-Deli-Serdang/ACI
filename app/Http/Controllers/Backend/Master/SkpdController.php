...
class SkpdController extends Controller
{
    ...
    {
        return view('backend.master.skpd.index');
    }
...
public function getData(Request $request)
    {
        ...
        try {
            ...
            $response = Http::withToken($token)
                ->get($baseUrl . '/api/skpd/datatables', $request->all());
        } catch (\Exception $e) {
            return response()->json([
                'status' => false,
        ...
        if (!$response->ok()) {
            return response()->json([
                'status' => false,
                'message' => $response->json()['message'] ?? 'Gagal mengambil data SKPD.'
            ], $response->status());
        }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $response = Http::withToken($token)
                ->post($baseUrl . '/api/skpd', $request->all());
        } catch (\Throwable $e) {
        ...
        if (!$response->ok()) {
            return response()->json([
                'status' => false,
                'message' => $response->json()['message'] ?? 'Gagal menyimpan data SKPD.'
            ], $response->status());
        }
    ...
    public function show($id)
    {
        ...
        $html = view('backend.master.skpd.show', ['data' => $data])->render();
    ...
    public function edit($id)
    {
        ...
        try {
            $response = Http::withToken($token)->get($baseUrl . '/api/skpd/' . $id);
        } catch (\Exception $e) {
        ...
        $html = view('backend.master.skpd.edit', ['data' => $data])->render();
        return response()->json(['html' => $html], 200);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $response = Http::withToken($token)
                ->put($baseUrl . '/api/skpd/' . $id, $request->all());
        } catch (\Throwable $e) {
            return response()->json(['status' => false, 'message' => 'Tidak dapat menghubungi server backend.'], 500);
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            $response = Http::withToken($token)->delete($baseUrl . '/api/skpd/' . $id);
        } catch (\Exception $e) {
            return response()->json(['status' => false, 'message' => 'Tidak dapat menghubungi server backend.'], 500);
        }
