        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var table = $('.chimox').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('help.log-activity.data') }}",
                        type: 'GET',
                    ...
                    columns: [{
                        ...
                        orderable: false,
                        searchable: false,
                        render: function (log_name, type, row) {
                            // row.id berisi ID dari log activity
                            return `<a href="/help/log-activity/${row.id}" class="text-primary fw-bold">
                                        ${log_name}
                                    </a>`;
                        }
                    },
