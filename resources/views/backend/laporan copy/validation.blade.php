                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content d-flex flex-column ps-3">
                                        ...
                                        @if (!empty($data['verif_file']))
                                            <a href="https://apiaci-deliserdangsehat.deliserdangkab.go.id/storage/verifikasi_laporan/{{ $data['id'] }}/{{ $data['verif_file'] }}"
                            ...
                            @if (!empty($data['selesai_tgl']))
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content d-flex flex-column ps-3">
                                        ...
                                        @if (!empty($data['verif_file']))
                                            <a href="https://apiaci-deliserdangsehat.deliserdangkab.go.id/storage/selesai_laporan/{{ $data['id'] }}/{{ $data['selesai_file'] }}"
                                                target="_blank" class="badge badge-light-primary mt-1 w-100px">
                                                <i class="ki-outline ki-file fs-4 me-1"></i> Lihat Bukti
                                            </a>
                                        @endif
