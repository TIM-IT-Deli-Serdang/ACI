                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-user-table-filter="search" id="search"
                            class="form-control  w-250px ps-13" placeholder="Cari kode | SKPD" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <table class="table align-middle table-row-dashed fs-7 gy-5 chimox" id="chimox">
                    <thead>
                        <tr class=" text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">Nama SKPD</th>
                            <th class="min-w-100px">Kepala SKPD</th>
                            <th class="text-start min-w-100px">NIP Kepala SKPD</th>
                            <th class="text-start min-w-100px">Latitude</th>
                            <th class="text-start min-w-100px">Longitude</th>
                            <th class="min-w-100px">Status</th>
                            <th class="text-end w-80px pe-4">Created At</th>
                            <th class="text-end w-80px pe-2">Updated At</th>
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add__scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="kode_skpd" id="kode_skpd" class="form-control mb-3 mb-lg-0"
                                placeholder="Contoh: 1.3302.03" />
                            <span class="text-danger error-text kode_skpd_error_add"></span>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="fv-row mb-7 col-6">
                                ...
                                <input type="text" name="latitude" id="latitude" class="form-control mb-3 mb-lg-0"
                                    placeholder="Contoh: -6.208806" />
                                <span class="text-danger error-text latitude_error_add"></span>
                            </div>
                            ...
                            <div class="fv-row mb-7 col-6">
                                ...
                                <input type="text" name="longitude" id="longitude" class="form-control mb-3 mb-lg-0"
                                    placeholder="Contoh: 106.845175" />
                                <span class="text-danger error-text longitude_error_add"></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- End Modal Show -->
    ...
    @push('scripts')
        ...
        <script>var BASE_MASTER_SKPD = "{{ url('master/skpd') }}";</script>
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(result, textStatus, xhr) {
                        // xhr.status biasanya 201 untuk created, 200 untuk ok
                        // success path: tampilkan pesan dari result.message atau fallback ke custom
                    ...
                    error: function(xhr, textStatus, errorThrown) {
                        ...
                        // Jika response JSON tersedia (biasanya API / proxy mengembalikan JSON)
                        var res = xhr.responseJSON;

                        if (xhr.status === 422 && res && res.errors) {
                            // tampilkan error per-field
                            $.each(res.errors, function(field, messages) {
                                // field bisa "kode_skpd" -> kita pakai class .kode_skpd_error_add
                ...
                $("body").on("click", ".btn-get-edit", function(e) {
                    ...
                    $.ajax({
                        url: "/master/skpd/" + id + "/edit",   // sesuaikan route
                        dataType: "json",
                        success: function(result) {
                            if (result.html) {
                ...
                $("body").on("submit", "#FormEditModalID", function(e) {
                    ...
                    $.ajax({
                        url: "/master/skpd/" + id,   // sesuaikan route update-mu
