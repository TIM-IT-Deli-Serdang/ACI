        ...
        <div class="d-flex flex-grow-1 flex-stack flex-wrap gap-2 mb-n10" id="kt_toolbar">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                    <li class="breadcrumb-item text-gray-900">List Kategori</li>
                </ul>
            </div>
                ...
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-user-table-filter="search" id="search"
                            class="form-control w-250px ps-13" placeholder="Cari Kategori..." />
                    </div>
                </div>
            </div>
                ...
                <form method="post" id="FormTambahModalID" class="form">
                    ...
                    <div class="modal-body px-5 my-2">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="nm_kategori" class="form-control mb-3 mb-lg-0"
                                placeholder="Contoh: Jalan Rusak" />
                            <span class="text-danger error-text nm_kategori_error_add"></span>
                        </div>
                    </div>
    ...
    <div class="modal fade shadow-sm" id="Modal_Show_Data" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content" id="show-modal-content">
                <div class="modal-header align-items-center py-6 border-gray-300">
                    <h4 class="fw-bold m-0">Detail Kategori</h4>
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                        <i class="ki-outline ki-cross fs-1 text-dark"></i>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                var table = $('.chimox').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('kategori.data') }}", // /master/kategori/data
                        type: 'GET',
                    },
                    columns: [
                        { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                        { data: 'nm_kategori', name: 'nm_kategori' }, // Sesuai API Backend
                ...
                $('#FormTambahModalID').on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "{{ route('kategori.store') }}", // /master/kategori (POST)
                        method: 'POST',
